...
private:
    ...
    //helper function used to calculate the index for the object
    unsigned getIndex(Person person);
    //Rehashes the current table into a new table with opposite probing
    void rehash();
};
#endif
